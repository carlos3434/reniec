...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <header class="masthead">
      <div class="container">
        <img class="img-fluid" src="web/img/profile.png" alt="">
      </div>
    </header>
    ...
    <section id="portfolio">
      ...
      <div class="container">
        <h2 class="text-center">Elige tu futuro</h2>
        <h2 class="text-center">2017</h2><br>
        <h4 class="text-center">Bienvenido al sitio de las proyecciones de Educacio superior y empleabilidad</h4>
